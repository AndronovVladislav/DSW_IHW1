...
public class Field {
    ...
    public Field () {
     ...
     public void redraw(char color, char oppositeColor) {
        System.out.print("\n\n\n\n\n\n\n\n");
    ...
    public boolean badMoveCheck(int cell, char color, char oppositeColor) {
    ...
    public void recolorDesk(int cell, char color) {
     ...
     public boolean detectSameColorCell(int cell, int horizontalShift, int verticalShift, char color) {
